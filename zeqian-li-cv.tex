...
\section{Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Pathway splitting}
      {I am building a fluorescence microscope to image spatial patterns of the hot spring microbial mats, using shotgun metagenomic data to analyze metabolic features of the hot spring community, and, in collaboration with a postdoc, studying the environmental determinants of cyanobacterial growth.
      }
      \resumeItem{Carbon }
      {(in collaboration with I am building a fluorescence microscope to image spatial patterns of the hot spring microbial mats, using shotgun metagenomic data to analyze metabolic features of the hot spring community, and, in collaboration with a postdoc, studying the environmental determinants of cyanobacterial growth.
      }
      \resumeItem{Closed eco-systems}
      {I am building a fluorescence microscope to image spatial patterns of the hot spring microbial mats, using shotgun metagenomic data to analyze metabolic features of the hot spring community, and, in collaboration with a postdoc, studying the environmental determinants of cyanobacterial growth.
      }
    ...
    \resumeSubheading
      ...
      I studied various biological systems (C. elegans development, C. elegans neural systems, artificial neural networks) using theoretical and computational tools stem from statistical physics.
    %   \resumeItemListStart
...
\resumeSubHeadingListStart
  ...
  \resumeSubheadingOneLine{Teaching experience}{\\ Teaching assistant for introductory physics courses in both the college and the graduate school.}
  % \resumeItemListStart
...
\section{Programming}
 \resumeSubHeadingListStart
  \resumeSubItem{Bioinformatics:}{basic omics tools, 16s data analysis, metagenome data analysis}
  \resumeSubItem{}{Python, Java, Javascript, C/C++, Matlab}
   \resumeSubItem{}{LaTeX}
 \resumeSubHeadingListEnd
